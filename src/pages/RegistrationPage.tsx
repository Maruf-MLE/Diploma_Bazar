...
export default function RegistrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "সফল",
        description: "রেজিস্ট্রেশন সম্পন্ন হয়েছে। অনুগ্রহ করে আপনার ইমেইল চেক করুন এবং ভেরিফিকেশন লিঙ্কে ক্লিক করুন।",
      })
      
      // সতর্কতা বার্তা দেখাই
      toast({
        title: "সতর্কতা",
        description: "ইমেইল ভেরিফিকেশন সম্পন্ন না করা পর্যন্ত আপনি সাইটের সকল ফিচার ব্যবহার করতে পারবেন না।",
        variant: "default"
      })
