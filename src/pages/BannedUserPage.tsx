        ...
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="bg-yellow-50 p-4 rounded-md border border-yellow-100 mt-6">
            ...
            <p className="text-sm text-gray-600 mt-1">
              যদি আপনি মনে করেন এটি ভুল হয়েছে, তাহলে support@boichapabazar.com এ ইমেইল করুন। আপনার ইউজার আইডি উল্লেখ করুন: <span className="font-mono bg-gray-100 px-1 py-0.5 rounded text-xs">{userId}</span>
            </p>
          </div>
        </CardContent>
